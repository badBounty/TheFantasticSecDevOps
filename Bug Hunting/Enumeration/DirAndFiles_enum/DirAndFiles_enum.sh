...
do
  ...
  echo "Starting directories and files enumeration..." | slackcat -c general
  ...
  echo "Directories and files enumeration finished." | slackcat -c general
