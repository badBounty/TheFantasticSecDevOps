...
echo "WebScanner - starting..." | slackcat -c $2 -s
...
echo "WebScanner - scanner done." | slackcat -c $2 -s

# Parsing phase
echo "WebScanner - parsing phase starting..." | slackcat -c $2 -s
...
# Zip
echo "WebScanner - compressing..." | slackcat -c $2 -s
...
echo "WebScanner - sending results..." | slackcat -c $2 -s
slackcat -c $2 -m $1_web_results.zip

echo "WebScanner - done." | slackcat -c $2 -s
