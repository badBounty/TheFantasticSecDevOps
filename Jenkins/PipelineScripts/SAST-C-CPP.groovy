...
def runStage(notifier, vulns)
{
    ...
    try 
    {
	  ...
	  sh "ssh -p ${env.SAST_Server_SSH_Port} -o StrictHostKeyChecking=no root@${env.SAST_Server_IP} python3 /home/parseFlawfinderResults.py /home/${projname}-flawfinder.csv /home/flawfinder-results-parsed.json ${projname}"
