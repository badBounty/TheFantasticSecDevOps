...
def runStage(notifier, vulns)
{
    ...
    try 
    {
	    ...
	    def insiderResults = sh(script: "ssh -p ${env.SAST_Server_SSH_Port} -o StrictHostKeyChecking=no root@${env.SAST_Server_IP} /home/insider --tech ${insiderTech} --target /home/${projname}",returnStdout: true) 
